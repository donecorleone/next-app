(function (global, factory) {
	...
	*/
	...
	function useResizeObserver(_temp, deps) {
	  ...
	  react.useEffect(function () {
	    if (!element) return;
	    var onResize = throttle(debounce, function (_ref2) {
	      var entry = _ref2[0];
	      entryRef.current = entry;
	      callback(entry);
	      if (!lazy) {
	  ...
	  }, [element, lazy, debounce, box].concat(deps));
	  var get = react.useCallback(function () {
	    return entryRef.current;
	  }, []);
	  return [setElement, lazy ? get : entry];
	...
	function useRect(_temp, deps) {
	  var _ref = _temp === void 0 ? {} : _temp,
	    ...
	    resizeDebounce = _ref$resizeDebounce === void 0 ? debounce : _ref$resizeDebounce,
	    _ref$callback = _ref.callback,
	  ...
	  react.useEffect(function () {
	    if (!element) return;
	    var onBodyResize = throttle(debounce, function () {
	      var top, left;
	      if (ignoreTransform) {
	  ...
	  }, [element, lazy, debounce, ignoreTransform].concat(deps));
